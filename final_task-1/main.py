...
from pyqtgraph import RectROI, exporters
from Color import SignalColorDialog
from NonRectangular import NonRectangleViewer
...
class MainWindow(QWidget):
    ...
    def take_snapshot(self):
        ...
        gluedGraph_plot = self.gluedGraph.plotItem  
